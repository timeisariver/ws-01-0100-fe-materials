...
const { Person, main } = require('../../002_class/001_class');
...
describe('Person', () => {
  ...
  test('#toString', () => {
    ...
    expect(person.toString()).toEqual(
      'name: ichiro, age: 20, bio: lorem ipsum',
    );
  });
});
...
describe('main', () => {
  ...
  test('main', () => {
    expect(main()).toEqual(
      'name: ichiro, age: 54, bio: I like to play basketball',
    );
  });
});
